   ...
   const getModal = ()=>{
     return(
      ...
      <div className="modal-content">
        <h4>{product.name}</h4>
        <p>Ürünü Mağazadan Silmek İstediğinize Emin misiniz?</p>
      </div>
   ...
   M.toast({html:res2.message,classes:"green"})
    ...
    return(
        <div className="container center-align">
            ...
            {user.role != 'user'
               && 
              <button data-target="modal1" className="btn modal-trigger waves-effect waves-light #c62828 red darken-3">Ürünü Sil
